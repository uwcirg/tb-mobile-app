...
const DaysAgo = ({ days }) => {
  ...
  return !(days === false)
    ? days > 0
      ? `${days} ${t("time.day_ago", { count: days })}`
      : t("patient.home.today")
    : t("coordinator.noReports");
};
...
const fields = [
  ...
  },
  {
    key: "treatmentStart",
    displayName: (
      <Translate string="coordinator.patientTableLabels.treatmentStart" />
    ),
    formatter: (value) =>
  ...
  },
  {
    ...
    displayName: (
      <Translate string="coordinator.patientTableLabels.lastSubmission" />
    ),
  ...
  },
  {
    key: "adherence",
    displayName: (
      <Translate string="coordinator.patientTableLabels.adherence" />
    ),
  ...
  },
  {
    key: "photoAdherence",
    displayName: (
      <Translate string="coordinator.patientTableLabels.photoAdherence" />
    ),
    formatter: percentComponent,
    align: "right",
  },
