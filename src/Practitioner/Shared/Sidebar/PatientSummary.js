...
const PatientDataSummmary = observer(() => {
  ...
  const adherence = `${Math.floor(
    practitionerStore.getSelectedPatient.adherence * 100
  )}%`;
  ...
  return (
    <div className={classes.patientInfo}>
      ...
      <ProfileItem
        ...
        value={practitionerStore.getSelectedPatient.daysInTreatment}
      />
      <ProfileItem
        text={t("coordinator.sideBar.lastContacted")}
        value={DateTime.fromISO(
          practitionerStore.getSelectedPatient.lastContacted
