...
const PatientInfo = observer(() => {
  ...
  const survey =
    patientProfileStore.selectedPatient.details.contactTracingSurvey;
      ...
      <div className={classes.details}>
        ...
        <div className={classes.detailGroup}>
          <Item
            ...
            bottom={patientProfileStore.selectedPatient.details.age || "N/A"}
          />
          <Item
            top={t("coordinator.patientProfile.gender")}
            bottom={patientProfileStore.selectedPatient.details.gender || "N/A"}
          />
          <Item
            top={t("coordinator.patientProfile.lastContacted")}
            bottom={getDate(
              patientProfileStore.selectedPatient.details.lastContacted
            )}
          />
        </div>
        <Item
