        ...
        <TableCell>
          <Grid className={classes.tags} container direction="column">
            {row.numberOfDaysAfterRequest > 0 && (
              <Tag backgroundColor={Colors.timelineYellow}>{`${
            ...
            {row.photoUrl && (
              <Tag backgroundColor={Colors.timelineGreen}>
                {t("report.photoSubmitted")}
              </Tag>
            )}
            {needSupport && (
              <Tag backgroundColor={Colors.calendarRed}>
                {t("dashboard.needsSupport")}
              </Tag>
            )}
            {missedPhoto && (
              <Tag backgroundColor={Colors.calendarRed}>
...
const Meds = ({ taken }) => {
  ...
  return <div className={classes.meds}>{taken ? <Check /> : <Clear />}</div>;
};
