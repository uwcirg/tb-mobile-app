        ...
        {patientList &&
          patientList.map((patient) => {
            return (
              ...
              >
                <p>
                  {patient.givenName} {patient.familyName[0]}.
                </p>
                {patient.reportingStatus &&
                patient.reportingStatus.today.reported ? (
                  <Report data={patient.reportingStatus.today} />
                ) : (
                  <Pending />
                )}
              </div>
