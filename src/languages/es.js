export default {
  home: {
    ...
    survey: "Control del Tratamiento",
  },

  icons: {
    medication: "Toma de medicamentos",
    symptoms: "Reportar efectos secundarios",
    photo: "Subir foto de la tira de prueba",
  },

  survey: {
      continue: "Continuar",
      skip: "Saltar esta opción",
  ...
  info: {
    faq: "Preguntas y respuestas sobre la tuberculosis",
    symptom_overview: "Resumen de los efectos indeseables",
  },
  ...
  menu: {
    ...
    language: "Idioma",
    treatment_start: "Fecha de inicio del tratamiento",
  ...
  notes: {
    ...
    hint: "Escriba sus notas aquí.",
    last_edited: "última edición",
  },

  symptom_overview: {
    title: "Resumen de los efectos indeseables y estrategias para reducirlos",
...
`,
      bullet_4: `
En algunos casos poco frecuentes la isoniazida (INH) puede provocar sensación de hormigueo o quemazón en la planta de los pies (neuropatía). Para prevenir esto se debe usar vitamina B6 junto con el tratamiento con INH.
`,
      bullet_5: `
Si aparece fiebre hay que evaluar la causa ya que a veces pueden ser ocasionados
por los medicamentos. Consulte evaluación médica
`,
    },
  },
  ...
  faqs: {
    ...
    intro_1: `
        Esta es una lista de preguntas frecuentes y las respuestas sobre la tuberculosis (TB),
  ...
  q4: {
    ...
    answer: {
      1: `
        ...
        segunda fase de 4 meses, necesaria para matar al resto de los bacilos
      ...
      3: `
        ...
        `,
      4: `
        Además de los análisis de rutina, es importante la evaluación del esputo (tos con catarro) principalmente en los 2 primeros meses, antes de pasar a la segunda fase del tratamiento.
        Esto permite saber si la TB dejó de ser contagiosa
      `,
      5: `
        Siempre se recomienda utilizar el tratamiento directamente observado (TAES), cuando un
        ...
        `,
      6: `
        Hay muchas razones por las cuales las personas pueden tener problemas para
        tomar sus medicamentos todos los días. Pero en la mayoría de los casos, hay algo que
        se puede hacer.
        `,
      7: `
    ...
    answer: {
      ...
      2: `
        ...
        *llame a su médico o enfermera inmediatamente*.
        ...
        `,
      3: `
        Consulte a su médico u otros servicios de emergencia de inmediato si tiene:
        `,
      4: {
      ...
      5: {
        ...
        2: `Si tiene alguno de estos síntomas, consulte inmediatamente a su médico o enfermera:`,
      },
      ...
      6: {
        ...
        18: `Vision borrosa o cambios en la vista`,
...
"rifampicina-bullets": {
  ...
  q6: {
    ...
    answer: {
      1: `
        ...
        cuenta que las bacterias de la tuberculosis aún están vivas
        ...
        sienta mejor y no tenga más síntomas de la enfermedad.
        `,
      2: `
  ...
  q7: {
    ...
    answer: {
      ...
      2: {
        ...
        3: `Marcar en un calendario cada día que toma sus medicamentos.`,
      ...
      "3-note": `
        ...
        `,
      3: `Si se olvida un día de tomar sus medicamentos,
  ...
  q8: {
    question: "¿Cómo puedo evitar transmitir la tuberculosis?",
