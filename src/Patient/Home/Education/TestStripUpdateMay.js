  ...
  return (
    <div className={classes.container}>
      <Typography className={classes.title} variant="h1">
        {t("mayTestStripUpdate.title")}
      </Typography>
      <Typography className={classes.subTitle} variant="h2">
        {t("mayTestStripUpdate.subtitle")}
      </Typography>
      <div className={classes.body}>
        <img className={classes.image} src="/img/new_test.png" />
        <Typography
          data-testid="education-body"
          className={classes.messageBody}
          variant="body1"
        >
          {t("mayTestStripUpdate.body")}
        </Typography>
        <div className={classes.buttons}>
          <NewButton
            onClick={handleTextClick}
            icon={<Info />}
            text={t("mayTestStripUpdate.textInstructions")}
          />
          <NewButton
            href="https://youtu.be/zkalmeCLaO8"
            icon={<Video />}
            text={t("mayTestStripUpdate.videoInstructions")}
          />
        </div>
      </div>
      <RateButtons />
