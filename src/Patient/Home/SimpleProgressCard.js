    ...
    return (
        <InteractionCard id="intro-progress-card" upperText={<><TrendingUpIcon /> {t("patient.home.cardTitles.myProgress")}</>}>
            <div className={classes.container}>
                ...
                <Typography className={classes.greatWork} variant="h2">Great work! 👍</Typography>
                <div className={classes.statContainer}>
                    <div className={classes.daysInTreatment}>
                      <span className={classes.treatmentDay}>{patientStore.patientInformation.daysInTreatment}</span><Typography variant="h2"> days in treatment</Typography>
                    </div>
                    <div className={classes.daysInTreatment}>
                        <span className={classes.streakDay}>{patientStore.getCurrentStreak}</span><Typography variant="h2"> consecutive reports</Typography>
                    </div>
                    </div>
                </div>
            </div>
