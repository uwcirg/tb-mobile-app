...
const Confirmation = observer(() => {
  ...
  return (
    <div className={classes.confirmationSuperContainer}>
      <ConfirmationLayout
        title={t("patient.home.completed.title")}
        subtitle={t("patient.home.completed.subtitle")}
      />
      {patientStore.todaysReportHasIssue && (
        <>
          <Box height=".5em" />
          <Typography className={classes.reportIssueText}>
            {t("patient.home.completed.issue")}
          </Typography>
        </>
      )}
      <Box height=".5em" />
