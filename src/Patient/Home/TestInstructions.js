  ...
  let handleTestInstructions = async () => {
    ...
    return(<div>
     <InteractionCard upperText="Walkthrough" id="test-instructions">
       <p>Now we can have something inside of here that looks a little prettier. And it also routes us</p>
      <NewButton onClick={handleTestInstructions} text="*translate*Click here" />
    </InteractionCard>
    </div>)
