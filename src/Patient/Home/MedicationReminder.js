  ...
  return (
    <InteractionCard
      upperText={
        <>
          <AccessAlarmIcon />
          {t("patient.reminders.medicationReminder")}
        </>
      }
    ...
    >
          ...
          <>
            ...
            >
              ...
              <Typography className={classes.reminderText} variant="body1">
                <SplitTextPreventWrapSpacing
                  text={t("patient.reminders.reminderEnabled")}
                />
              </Typography>
              <Typography
                align="center"
              ...
              <Typography
                ...
                variant="body1"
              >
                {DateTime.fromISO(patientStore.reminderTime).toLocaleString(
            ...
            >
              <ClickableText
                ...
                onClick={handleClick}
                icon={<MoreVertIcon style={{ fontSize: "1.2em" }} />}
                text={t("patient.reminders.options")}
              ></ClickableText>
            </Grid>
            {anchorEl && (
              <MenuTest
                anchorEl={anchorEl}
                handleChange={openTimeDialog}
                handleClose={handleClose}
                handleDisable={patientStore.disableMedicationReminder}
              />
            )}
          </>
        ) : (
          <>
            ...
            >
              <Grid wrap="nowrap" alignItems="center" container>
                ...
                >
                  {" "}
                  {t("patient.reminders.reminderDisabled")}
                </Typography>
              </Grid>
            </Grid>

            <Grid
              className={classes.disabledBottom}
              container
              alignItems="center"
              wrap="nowrap"
            >
              <Typography className={classes.reminderText}>
                {t("patient.reminders.explanation")}
              </Typography>
              <Option
      ...
      <TimeDialog
        ...
        setValue={(value) => {
          patientStore.newReminderTime = value;
        }}
...
const Option = (props) => {
  ...
  return (
    <Button
      {...props}
      disableElevation
      className={`${classes.enable} ${props.className}`}
    />
  );
};
  ...
  return (
    ...
    >
      <MenuItem
        ...
        onClick={change}
      >
        {t("patient.reminders.changeTime")}
      </MenuItem>
      <MenuItem style={{ color: Colors.red }} onClick={disable}>
        {t("patient.reminders.disable")}
      </MenuItem>
    </Menu>
  );
};
