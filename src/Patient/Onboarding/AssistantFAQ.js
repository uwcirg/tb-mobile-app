...
const AssistantFAQ = () => {
  ...
  return (
    <div className={classes.faq}>
      ...
      <ul>
        {t("patient.onboarding.coordinator.will.items", {
          returnObjects: true,
        }).map((each) => {
          return (
            <li>
              {" "}
              <CheckIcon className={classes.green} /> {each}
            </li>
          );
        })}
      </ul>
      ...
      <ul>
        {t("patient.onboarding.coordinator.wont.items", {
          returnObjects: true,
        }).map((each) => {
          return (
            <li>
              <XIcon className={classes.red} /> {each}
            </li>
          );
        })}
      </ul>
