      ...
      <div className={classes.container}>
        ...
        >
          ...
          <Typography align="center" variant="h1" color="initial">
            {t("patient.onboarding.notification.header")}
          </Typography>
        </Grid>
        <img
          className={classes.image}
          src="/img/es-Ar/notification-instructions/example.png"
        />
        <Typography className={classes.listTitle} variant="body1">
          {t("patient.onboarding.notification.whenPrompted")}{" "}
          <strong>{t("patient.onboarding.notification.permit")}</strong>
        </Typography>
        <Typography variant="body1">
          {" "}
          {t("patient.onboarding.notification.listHeader")}:
        </Typography>
