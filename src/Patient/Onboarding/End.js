      ...
      <div className={props.bodyClass}>
        <div>
          ...
          <Typography className={classes.text} variant="h2">
            {t("patient.onboarding.endText")}
          </Typography>
          {activationStore.activationErrorDetail && (
            <Typography variant="body1">
              {t("commonWords.error")}: {activationStore.activationErrorDetail}{" "}
            </Typography>
          )}
          {activationStore.activationError && (
            <Alert
              handleClose={activationStore.clearActivationError}
              severity="error"
            >
