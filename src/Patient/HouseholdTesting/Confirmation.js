  ...
  return (
    <>
      ...
      <NextButton
        ...
        text={t("patient.report.symptoms.warning.button")}
      />
    </>
  );
};
...
const CompletionMessage = ({ completed }) => {
  ...
  return (
    <Typography
      className={completed ? classes.success : classes.reachOut}
      variant="body1"
    >
      {completed
        ? t("householdTesting.completed")
        : t("householdTesting.reachOut")}
    </Typography>
  );
};
