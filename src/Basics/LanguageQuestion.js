    ...
    <div className={classes.languageContainer}>
      ...
      <ButtonGroup className={classes.group} fullWidth color="primary">
        <Button
          ...
          className={
            uiStore.locale === "en" ? classes.selected : classes.default
          }
        >
          {t("patient.profile.options.english")}
        </Button>
        <Button
          onClick={() => {
            uiStore.setLocale("es-AR");
          }}
          className={
            uiStore.locale === "es-AR" ? classes.selected : classes.default
          }
        >
          {t("patient.profile.options.spanish")}
        </Button>
      </ButtonGroup>
    </div>
  );
