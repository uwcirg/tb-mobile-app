      ...
      <div className={classes.monthContainer}>
        <div className={classes.timeline}>
          {props.showLabel && (
            <div
              id="month-label"
              className={`${classes.monthNumber} ${classes.monthLabel}`}
            >
              {t("time.month")}
            </div>
          )}
          <div
            className={`${classes.monthNumber} ${
              props.isCurrentMonth && classes.currentMonth
            }`}
          >
            {props.month}
          </div>
        ...
        <div
          className={`${classes.panelContainer} ${
            props.isCurrentMonth && classes.currentMonthBackground
          }`}
        >
  ...
  return (
    <>
      <div className={`${classes.monthPreview} monthPreview`}>
        <div className={`${classes.monthNumber} ${classes.monthLabel}`}>
          {t("time.month")}
        </div>
