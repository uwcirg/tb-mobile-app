...
export default class PatientProfileStore {
  ...
  getPatientNotes = (patientID) => {
    return this.apiHelper
      .executeRawRequest(
        `/patient/${patientID || this.selectedPatient.details.id}/notes`
      )
      .then((response) => {
  ...
  @action toggleUpdateOutcome = () => {
    this.treatmentOutcome.treatmentOutcome =
      this.selectedPatient.details.treatmentOutcome.treatmentOutcome;
    this.treatmentOutcome.appEndDate =
      this.selectedPatient.details.treatmentOutcome.appEndDate;
