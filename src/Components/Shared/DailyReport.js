...
import TempIcon from '../../Basics/Icons/Temp'
...
const DailyReport = (props) => {
    ...
    if(!report) return (<p>No report submitted on this day</p>);
    ...
    return (<div className={`${classes.container}`}>
        <ListItem first negative={!props.medicationWasTaken} icon={<PillIcon />} title={t("commonWords.medication")} editAction={patientUIStore.editReport} hideEdit={props.pastReport} >
            <p> {report.medicationWasTaken ? `${t("coordinator.patientProfile.taken")}` : `${t("patient.report.confirmation.notTaken")}:`}</p>
